        ...
        <div className="px-4 sm:px-6 lg:px-8 ">
          ...
          <div className="mx-auto mt-10 grid max-w-xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-1">
            ...
            >
              ...
              <p className="mt-2 text-primary dark:text-primary">Amazon Web Services</p>
              <p className="mt-2 text-gray-500 dark:text-gray-400">Issued: July 2021</p>
              <p className="mt-2 text-gray-600 dark:text-gray-300">Validate your overall understanding of the AWS Cloud with an industry-recognized credential.</p>
            </Card>
          </div>
        </div>
      </section>
